...
tk.Label(frame, text="Rock Paper Scissors", font="ariel 20 bold", fg="red").grid(row=0, column=0, columnspan=3, pady=5)
...
result_label = tk.Label(frame, textvariable=result_var, font="ariel 20 bold", bg="yellow", width=15, borderwidth=2, relief="solid")
...
tk.Button(frame, text="Play Again", font='10',fg="white", bg="orange", command=play_again).grid(row=6, columnspan=3, pady=10)
