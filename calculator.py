...
def equal_button():
    ...
    entry_field.delete(0, END)
    # condition statement to determine operation to use for calculator
    if operation == "add":
...
entry_field = Entry(app, width=35,justify="right",borderwidth=5,# font=("helvetica", 20,"bold")
)
# make the entry field into grid giving it a columnspan to address for other columns in the other rows
