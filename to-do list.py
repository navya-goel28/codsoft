...
# define my fonts
my_font = Font(family='Chiller Regular',size=30,weight='normal')
# create frame
my_frame = Frame(root)
my_frame.pack(pady=10)
# create list of todo
my_list = Listbox(my_frame,font=my_font,width=25,height=5,bg= "SystemButtonFace",bd=0,fg="gray",highlightthickness=0,selectbackground= "#C948C4",activestyle="none")
...
def cross_out_task():
    ...
    # cross out task
    my_list.itemconfig(my_list.curselection(),fg= "gray")
...
def delete_crossed_task():
    ...
    while count < my_list.size():
        if my_list.itemcget(count, "fg") == "gray":
...
# Add some buttons 
delete_button = Button(button_frame, background='purple', text= "Delete Task",  fg='white',command=delete_task)
add_button = Button(button_frame, background='purple', text= "Add Task", fg='white',command=add_task)
cross_out_button = Button(button_frame, background='purple', text="Cross-Out Task", fg='white', command=cross_out_task)
uncross_out_button = Button(button_frame, background='purple', text="Uncross-Out Task", fg='white', command=uncross_out_task)
delete_crossed_button = Button(button_frame, background='purple', text="Delete Crossed-Out Task", fg='white', command=delete_crossed_task)
